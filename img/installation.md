...
## Toshiba / Carrier
### รุ่นที่รองรับ
แอร์ Carrier / Toshiba ประเภท ติดผนัง (Wall-Type) 
- เชื่อมต่อผ่านสายที่ทางโรงงานเตรียมไว้ในกล่องไฟ เช่นรุ่น X-Inverter* / ION Strike / Copper 11* 
- เชื่อมต่อบนบอร์ดคอนโทรล ช่อง `CN21` หรือ `CN22`

\* หากแอร์มี Wi-Fi Module มาจากโรงงานแล้ว สามารถใช้แทนโมดูลเดิมได้

**สามารถตรวจสอบรุ่นที่รองรับได้จาก** [Google Sheets](https://docs.google.com/spreadsheets/d/1LsEGS0IqN1i_Od7n3RD5Nc9AyF3FmkUIxi9akQcPdeA/edit?usp=sharing)

### การติดตั้ง
1. **ปิดเบรกเกอร์**
2. เชื่อมต่อตัวโมดูลเข้ากับเครื่องปรับอากาศ
    - หากแอร์มาพร้อมกับระบบ Wi-Fi อยู่แล้ว ให้ทำการถอดโมดูลที่มาจากโรงงานออก และเสียบเข้าได้เลย
    - หากเป็นรุ่นที่มีสายเชื่อมต่อ Wi-Fi มารออยู่แล้ว ให้ถอดฝาครอบกล่องไฟออก สามารถเสียบเข้าได้เลย
    - หากไม่มีสายมารอ ให้ทำการแกะหน้ากากของแอร์และตัวกล่องคอนโทรล เพื่อเสียบสายไปยังบอร์ด PCB

5. ติดตั้งตัวโมดูลไว้ยังด้านหน้าของเครื่องหรือตำแหน่งอื่นด้านนอก ไม่ควรใส่ไว้ในกล่องแผงวงจรเนื่องจากจะทำให้ประสิทธิภาพการรับสัญญาณ Wi-Fi ลดลง
6. **เปิดเบรกเกอร์** แล้วตรวจสอบไฟสถานะของโมดูล
7. [ทำการเชื่อมต่อเข้าแอป](/setup-tuya.md)

![installation-carrier](../img/installation-carrier.jpeg )

#### การแกะแอร์ Carrier (สำหรับรุ่นที่ไม่มีสายด้านหน้า)
